...
class ReorderPinNotesUsecase implements Usecase<void, PinParams> {
  ReorderPinNotesUsecase({required PinnedRepo repo}) : _repo = repo;

  final PinnedRepo _repo;

  @override
  Future<void> call(PinParams params) =>
      _repo.reorderPins(pinId: params.pinId, newOrder: params.notesOrder!);
}
